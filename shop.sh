...
sudo apt install mysql-server mysql-client libssl-dev -y
...
sudo wget https://github.com/nopSolutions/nopCommerce/releases/download/release-${Gitnopcommerceversion}/nopCommerce_${Gitnopcommerceversion}_NoSource_linux_x64.zip
